...
class _MarketRideWidgetState extends State<MarketRideWidget> {
  ...
  void initState() {
    ...
    _model.originFocusNode!.addListener(_handleFocusChange);
    _model.destinationFocusNode!.addListener(_handleFocusChange);
  ...
  void _handleFocusChange() {
    setState(() {
      _showImage = !(_model.originFocusNode!.hasFocus ||
          _model.destinationFocusNode!.hasFocus);
    });
  }
  @override
  void dispose() {
                            ...
                            Column(
                              ...
                              children: [
                                ...
                                Row(
                                  ...
                                  children: [
                                    Padding(
                                      padding: EdgeInsetsDirectional.fromSTEB(0.0, 5.0, 0.0, .0),
                                      child: Container(
                                        // ✅ RESPONSIVE WIDTH
                                        ...
                                        child: GooglePlaceAutoCompleteTextField(
                                          ...
                                          textEditingController: _model.originTextController,

                                          googleAPIKey: "AIzaSyDZkxRpoy0BOIAPwMaMIvAd5xpCe-6ZYvs",
                                          // onChanged: () {},
                                          inputDecoration: InputDecoration(
                                            labelText: 'Like, From Rishikesh', // ✅ use this
                                            labelStyle: FlutterFlowTheme.of(context).bodyMedium.override(
                                              color: Color(0xFF999999),
                                            ),
                                            floatingLabelBehavior: FloatingLabelBehavior.never, // ✅ keep it centered
                                            ...
                                            contentPadding: EdgeInsetsDirectional.fromSTEB(16.0, 0.0, 16.0, 14.0),
                                          ...
                                          itemClick: (prediction) {
                                            _model.originTextController.text = prediction.description ?? "";
                                            _model.originTextController.selection = TextSelection.fromPosition(
                                    ...
                                    Padding(
                                      ...
                                      child: Container(
                                        ...
                                        child: GooglePlaceAutoCompleteTextField(
                                          ...
                                          textEditingController: _model.destinationTextController,
                                          googleAPIKey: "AIzaSyDZkxRpoy0BOIAPwMaMIvAd5xpCe-6ZYvs",
                                          inputDecoration: InputDecoration(
                                            labelText: 'Like, To Agra', // ✅ use this
                                            labelStyle: FlutterFlowTheme.of(context).bodyMedium.override(
                                              color: Color(0xFF999999),
                                            ),
                                            floatingLabelBehavior: FloatingLabelBehavior.never, // ✅ keep it centered
                                          ...
                                          isLatLngRequired: false,
                                          itemClick: (prediction) {
                                            _model.destinationTextController.text = prediction.description ?? "";
                                            _model.destinationTextController.selection = TextSelection.fromPosition(
                                              TextPosition(offset: prediction.description?.length ?? 0),
                                            );
                                          },
                                          itemBuilder: (context, index, prediction) {
