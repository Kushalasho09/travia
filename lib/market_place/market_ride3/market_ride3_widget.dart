                ...
                Align(
                  ...
                  child: Padding(
                    ...
                    child: Column(
                                    ...
                                    children: [
                                      ...
                                      Expanded(
                                        child: Column(
                                          ...
                                          children: [
                                            Text(
                                              FFAppState().Descriptionoftheitem,
                                      ...
                                      Container(
                                        ...
                                        decoration: BoxDecoration(
                                          ...
                                          image: DecorationImage(
                                            fit: BoxFit.cover,
                                            image: Image.network('500x500?bakery').image,
                                          ),
                        ...
                        InkWell(
                          ...
                          onTap: () async {
                            ...
                            if (selectedMedia != null && selectedMedia.every((m) => validateFileFormat(m.storagePath, context))) {
                              safeSetState(() => _model.isDataUploading_uploadDataCdwjvinsuh = true);
                              ...
                              try {
                                ...
                                _model.isDataUploading_uploadDataCdwjvinsuh = false;
                              }
                              if (selectedUploadedFiles.length == selectedMedia.length && downloadUrls.length == selectedMedia.length) {
                                safeSetState(() {
                                  _model.uploadedLocalFile_uploadDataCdwjvinsuh = selectedUploadedFiles.first;
                                  _model.uploadedFileUrl_uploadDataCdwjvinsuh = downloadUrls.first;
                                });
                      ...
                      Builder(
                        builder: (context) =>
                            StreamBuilder<List<AdminApprovalOnRidesRecord>>(
                              ...
                              builder: (context, snapshot) {
                                ...
                                final adminApproval = snapshot.data!.first;

                                return FFButtonWidget(
                                  text: 'Post Now',
                                  onPressed: () async {
                                    // ✅ IMAGE CHECK
                                    if (_model.uploadedFileUrl_uploadDataCdwjvinsuh == null ||
                                        _model.uploadedFileUrl_uploadDataCdwjvinsuh!.isEmpty) {
                                      await showDialog(
                                        context: context,
                                    ...
                                    // ✅ SAVE DATA
                                    await MarketPlaceRecord.collection.doc().set(
                                      createMarketPlaceRecordData(
                                        productName: FFAppState().NameoftheProducts,
                                        origin: FFAppState().origin,
                                        destination: FFAppState().destination,
                                        descriptionItem: FFAppState().Descriptionoftheitem,
                                        ...
                                        _model.uploadedFileUrl_uploadDataCdwjvinsuh,
                                        arivalDate:
                                        FFAppState().marketPlaceAriveDate,
                                        // status: adminApproval.isDirectApproved,
                                        status: 'Under Review',  // Hardcode instead of adminApproval.isDirectApproved
                                      ),
                                    );
                                    ...
                                    await showDialog(
                                      ...
                                      builder: (dialogContext) {
                                        ...
                                        return const Dialog(
                                          ...
                                          child: ThankYouMarketPlaceWidget(),
                                        );
                                      },
                                    );
                                  },
