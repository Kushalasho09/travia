                        ...
                        children: [
                                                ...
                                                children: [
                                                  ...
                                                  InkWell(
                                                    ...
                                                    highlightColor:
                                                        Colors.transparent,
                                                    onTap: () async {
                                                      if ((_model.orgineTextController
                                                                      .text !=
                                                                  null &&
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      mainAxisAlignment:
                                                                          MainAxisAlignment
                                                                              .center,
                                                                      children: [
                                                                        if (listViewAdminSetDateRecord.dateList !=
                                                                            null)
                                                                          Align(
                                                                            alignment:
                                                                                AlignmentDirectional(0.0, 0.0),
                                                                        ...
                                                                        if (listViewAdminSetDateRecord.dateList !=
                                                                          ...
                                                                          Text(
                                                                            dateTimeFormat("LLL",
                                                                                listViewAdminSetDateRecord.dateList!),
                                                                            textAlign:
                                                                                TextAlign.center,
                                                                            style: FlutterFlowTheme.of(context).titleMedium.override(
                                                                                  font: GoogleFonts.interTight(
                                                                  ...
                                                                  child:
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      children:
                                                                              ...
                                                                              child: Column(
                                                                                ...
                                                                                children: [
                                                                                  Padding(
                                                                                    ...
                                                                                    child: Text(
                                                                                      listViewMarketPlaceRecord.descriptionItem,
                                                                        ...
                                                                        if (listViewMarketPlaceRecord.postedBy !=
                                                                            null)
                                                                          Row(
                                                                            mainAxisSize:
                                                                                MainAxisSize.max,
                          ...
                          Column(
                            ...
                            children: [
                                ...
                                Expanded(
                                  child: Padding(
                                    ...
                                    child: StreamBuilder<
                                      ...
                                      stream: queryBidsForMarketPlaceRecord(
                                        queryBuilder:
                                            (bidsForMarketPlaceRecord) =>
                                                bidsForMarketPlaceRecord.where(
                                          'bidsCreatorID',
                                      ...
                                      builder: (context, snapshot) {
                                        ...
                                        return ListView.separated(
                                          ...
                                          itemBuilder:
                                              (context, allBookingsIndex) {
                                            final allBookingsBidsForMarketPlaceRecord =
                                                allBookingsBidsForMarketPlaceRecordList[
                                                    allBookingsIndex];
                                            return StreamBuilder<
                                                MarketPlaceRecord>(
                                              stream: MarketPlaceRecord.getDocument(
                                                            ...
                                                            children: [
                                                              ...
                                                              Container(
                                                                ...
                                                                decoration:
                                                                    BoxDecoration(
                                                                  color: () {
                                                                    if (allBookingsBidsForMarketPlaceRecord
                                                                            .status ==
                                                                        'Completed') {
                                                                      return FlutterFlowTheme.of(
                                                                              context)
                                                                          .success;
                                                                    } else if (allBookingsBidsForMarketPlaceRecord
                                                                            .status ==
                                                                        'Accepted') {
                                                                      return Color(
                                                                          0xFFFD803D);
                              ...
                              if (_model.showMyBookings == 'Pending')
                                Expanded(
                                  child: Padding(
                                    padding: EdgeInsetsDirectional.fromSTEB(
                                        6.0, 5.0, 6.0, 5.0),
                                                            ...
                                                            children: [
                                                              ...
                                                              Container(
                                                                ...
                                                                decoration:
                                                                    BoxDecoration(
                                                                  color: () {
                                                                    if (pendingBookingsBidsForMarketPlaceRecord
                                                                            .status ==
                                                                        'Completed') {
                                                                      return FlutterFlowTheme.of(
                                                                              context)
                                                                          .success;
                                                                    } else if (pendingBookingsBidsForMarketPlaceRecord
                                                                            .status ==
                                                                        'Accepted') {
                                                                      return Color(
                                                                          0xFFFD803D);
                              ...
                              if (_model.showMyBookings == 'Accepted')
                                Expanded(
                                  child: Padding(
                                    padding: EdgeInsetsDirectional.fromSTEB(
                                        6.0, 5.0, 6.0, 5.0),
                                                            ...
                                                            children: [
                                                              ...
                                                              Container(
                                                                ...
                                                                decoration:
                                                                    BoxDecoration(
                                                                  color: () {
                                                                    if (acceptedBookingsBidsForMarketPlaceRecord
                                                                            .status ==
                                                                        'Completed') {
                                                                      return FlutterFlowTheme.of(
                                                                              context)
                                                                          .success;
                                                                    } else if (acceptedBookingsBidsForMarketPlaceRecord
                                                                            .status ==
                                                                        'Accepted') {
                                                                      return Color(
                                                                          0xFFFD803D);
                              ...
                              if (_model.showMyBookings == 'Completed')
                                Expanded(
                                  child: Padding(
                                    padding: EdgeInsetsDirectional.fromSTEB(
                                        6.0, 5.0, 6.0, 5.0),
                                                            ...
                                                            children: [
                                                              ...
                                                              Container(
                                                                ...
                                                                decoration:
                                                                    BoxDecoration(
                                                                  color: () {
                                                                    if (completedBookingsBidsForMarketPlaceRecord
                                                                            .status ==
                                                                        'Completed') {
                                                                      return FlutterFlowTheme.of(
                                                                              context)
                                                                          .success;
                                                                    } else if (completedBookingsBidsForMarketPlaceRecord
                                                                            .status ==
                                                                        'Accepted') {
                                                                      return Color(
                                                                          0xFFFD803D);
                                                            ...
                                                            children: [
                                                              ...
                                                              Container(
                                                                ...
                                                                decoration:
                                                                    BoxDecoration(
                                                                  color: () {
                                                                    if (rejectedBookingsBidsForMarketPlaceRecord
                                                                            .status ==
                                                                        'Completed') {
                                                                      return FlutterFlowTheme.of(
                                                                              context)
                                                                          .success;
                                                                    } else if (rejectedBookingsBidsForMarketPlaceRecord
                                                                            .status ==
                                                                        'Accepted') {
                                                                      return Color(
                                                                          0xFFFD803D);
                          ...
                          Column(
                            ...
                            children: [
                              FlutterFlowDropDown<String>(
                                controller:
                                    _model.listingDropDownValueController ??=
                                ...
                                onChanged: (val) async {
                                  safeSetState(
                                      () => _model.listingDropDownValue = val);
                              ...
                              if (_model.myListingStatus == 'All')
                                Expanded(
                                  child: Padding(
                                    padding: EdgeInsets.all(5.0),
                                    child:
                                        StreamBuilder<List<MarketPlaceRecord>>(
                                      stream: queryMarketPlaceRecord(
                                        queryBuilder: (marketPlaceRecord) =>
                                            marketPlaceRecord.where(
                                          'postedBy',
                                          isEqualTo: currentUserReference,
                                        ),
                                      ),
                                                              ...
                                                              Text(
                                                                ...
                                                                style: FlutterFlowTheme.of(
                                                                    ...
                                                                    .override(
                                                                      ...
                                                                      color:
                                                                          () {
                                                                        if (allListingMarketPlaceRecord.status ==
                                                                            'Active') {
                                                                          return FlutterFlowTheme.of(context)
                                                                              .success;
                                                                        } else if (allListingMarketPlaceRecord.status ==
                                                                            'Rejected') {
                                                                          return FlutterFlowTheme.of(context)
                                                                              .error;
                                                                        } else {
                                                          ...
                                                          Row(
                                                            ...
                                                            children: [
                                                              InkWell(
                                                                ...
                                                                onDoubleTap:
                                                                    () async {
                                                                  await allListingMarketPlaceRecord
                                                                      .reference
                                                                      .delete();
                                                                },
                                                                child: Icon(
                              ...
                              if (_model.myListingStatus == 'Under Review')
                                Expanded(
                                  child: Padding(
                                    padding: EdgeInsets.all(5.0),
                                    child:
                                                              ...
                                                              Text(
                                                                ...
                                                                style: FlutterFlowTheme.of(
                                                                    ...
                                                                    .override(
                                                                      ...
                                                                      color:
                                                                          () {
                                                                        if (underReviewMarketPlaceRecord.status ==
                                                                            'Active') {
                                                                          return FlutterFlowTheme.of(context)
                                                                              .success;
                                                                        } else if (underReviewMarketPlaceRecord.status ==
                                                                            'Rejected') {
                                                                          return FlutterFlowTheme.of(context)
                                                                              .error;
                                                                        } else {
                                                          ...
                                                          Row(
                                                            ...
                                                            children: [
                                                              InkWell(
                                                                ...
                                                                onDoubleTap:
                                                                    () async {
                                                                  await underReviewMarketPlaceRecord
                                                                      .reference
                                                                      .delete();
                                                                },
                                                                child: Icon(
                              ...
                              if (_model.myListingStatus == 'Live')
                                Expanded(
                                  child: Padding(
                                    padding: EdgeInsets.all(5.0),
                                    child:
                                      ...
                                      builder: (context, snapshot) {
                                        ...
                                        List<MarketPlaceRecord>
                                            liveLisitngMarketPlaceRecordList =
                                            snapshot.data!;
                                        if (liveLisitngMarketPlaceRecordList
                                            .isEmpty) {
                                          return NoMarketPlaceRideDriverWidget();
                                        }
                                        ...
                                        return ListView.separated(
                                          ...
                                          separatorBuilder: (_, __) =>
                                              SizedBox(height: 15.0),
                                          itemBuilder:
                                              (context, liveLisitngIndex) {
                                            final liveLisitngMarketPlaceRecord =
                                                liveLisitngMarketPlaceRecordList[
                                                    liveLisitngIndex];
                                            return StreamBuilder<UsersRecord>(
                                              stream: UsersRecord.getDocument(
                                                  liveLisitngMarketPlaceRecord
                                                      .postedBy!),
                                              builder: (context, snapshot) {
                                                // Customize what your widget looks like when it's loading.
                                                if (!snapshot.hasData) {
                                                              ...
                                                              Text(
                                                                ...
                                                                style: FlutterFlowTheme.of(
                                                                    ...
                                                                    .override(
                                                                      ...
                                                                      color:
                                                                          () {
                                                                        if (liveLisitngMarketPlaceRecord.status ==
                                                                            'Active') {
                                                                          return FlutterFlowTheme.of(context)
                                                                              .success;
                                                                        } else if (liveLisitngMarketPlaceRecord.status ==
                                                                            'Rejected') {
                                                                          return FlutterFlowTheme.of(context)
                                                                              .error;
                                                                        } else {
                                                          ...
                                                          Row(
                                                            ...
                                                            children: [
                                                              InkWell(
                                                                ...
                                                                onDoubleTap:
                                                                    () async {
                                                                  await liveLisitngMarketPlaceRecord
                                                                      .reference
                                                                      .delete();
                                                                },
                                                                child: Icon(
                              ...
                              if (_model.myListingStatus == 'Rejected')
                                Expanded(
                                  child: Padding(
                                    padding: EdgeInsets.all(5.0),
                                    child:
                                                              ...
                                                              Text(
                                                                ...
                                                                style: FlutterFlowTheme.of(
                                                                    ...
                                                                    .override(
                                                                      ...
                                                                      color:
                                                                          () {
                                                                        if (rejectedLisitngMarketPlaceRecord.status ==
                                                                            'Active') {
                                                                          return FlutterFlowTheme.of(context)
                                                                              .success;
                                                                        } else if (rejectedLisitngMarketPlaceRecord.status ==
                                                                            'Rejected') {
                                                                          return FlutterFlowTheme.of(context)
                                                                              .error;
                                                                        } else {
                                                          ...
                                                          Row(
                                                            ...
                                                            children: [
                                                              InkWell(
                                                                ...
                                                                onDoubleTap:
                                                                    () async {
                                                                  await rejectedLisitngMarketPlaceRecord
                                                                      .reference
                                                                      .delete();
                                                                },
                                                                child: Icon(
