...
class RideDetailsCustomerWidget extends StatefulWidget {
  ...
  @override
  State<RideDetailsCustomerWidget> createState() =>
      _RideDetailsCustomerWidgetState();
}

class _RideDetailsCustomerWidgetState extends State<RideDetailsCustomerWidget>
            ...
            body: SafeArea(
              ...
              child: StreamBuilder<UsersRecord>(
                stream: UsersRecord.getDocument(
                    rideDetailsCustomerRidesNewRecord.creatorID!),
                builder: (context, snapshot) {
                  // Customize what your widget looks like when it's loading.
                  if (!snapshot.hasData) {
                    return Center(
                                                  ...
                                                  children: [
                                                                ...
                                                                children: [
                                                                  ...
                                                                  Text(
                                                                    valueOrDefault<
                                                                        String>(
                                                                      formatNumber(
                                                                        functions.averageRating(columnUsersRecord
                                                                            .ratings
                                                                            .toList()),
                                                                        formatType:
                                                                            FormatType.compact,
                                                    ...
                                                    Row(
                                                      mainAxisSize:
                                                          MainAxisSize.max,
                                                      children: [
                                                        if (rideDetailsCustomerRidesNewRecord
                                                                .modeOfTransport ==
                                                            'Car')
                                                          Padding(
                                                            padding:
                                                        ...
                                                        children: [
                                                          ...
                                                          Padding(
                                                            ...
                                                            child: Text(
                                                              dateTimeFormat(
                                                                  "MMMEd",
                                                                  rideDetailsCustomerRidesNewRecord
                                                                      .createdTime!),
                                                              textAlign:
                                                                  TextAlign
                                                                      .start,
                                                            ...
                                                            InkWell(
                                                              ...
                                                              highlightColor:
                                                                  Colors
                                                                      .transparent,
                                                              onTap: () async {
                                                                await rideDetailsCustomerRidesNewRecord
                                                                    .reference
                                                                    .update(
