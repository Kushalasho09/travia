                      ...
                      Align(
                        ...
                        child: Padding(
                          ...
                          child: InkWell(
                            ...
                            onTap: () async {
                              // First, save the selected values
                              ...
                              print('✅ Selected items saved: ${FFAppState().carryItemNormalRides}');

                              // Then, clear the selected values in the model
                              if (_model.choiceChipsValues != null) {
                                _model.choiceChipsValues!.clear();
                                safeSetState(() {});
                                print('🗑️ Selection cleared from UI');
                              }
