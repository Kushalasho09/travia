...
import 'ride_rules7_model.dart';
export 'ride_rules7_model.dart';

class RideRules7Widget extends StatefulWidget {
  const RideRules7Widget({super.key});

  static String routeName = 'rideRules7';
  static String routePath = '/rideRules7';

  @override
  State<RideRules7Widget> createState() => _RideRules7WidgetState();
}

class _RideRules7WidgetState extends State<RideRules7Widget> {
  late RideRules7Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => RideRules7Model());
  }
                ...
                child: SingleChildScrollView(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      if (FFAppState().isRiderulesAccepted == false)
                        Padding(
                                ...
                                ...List.generate(7, (index) {
                                  ...
                                  return Padding(
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        Padding(
                                          padding: EdgeInsetsDirectional.only(end: 8.0, top: 1.0),
                                          child: Text(
                                            '•',
                                            style: TextStyle(
                                              color: Color(0xFF333333),
                        ...
                        ),                      if (FFAppState().isRiderulesAccepted == true)
                        Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            if (FFAppState().isRiderulesAccepted == false)
                              FFButtonWidget(
                                onPressed: () async {
                                  FFAppState().isRiderulesAccepted = true;
                                  safeSetState(() {});
                                },
                                text: 'Accept All',
                            ...
                            if (FFAppState().isRiderulesAccepted == true)
                              FFButtonWidget(
                                onPressed: () async {
                                  FFAppState().isRiderulesAccepted = false;
                                  safeSetState(() {});
                                },
                                text: 'Reject',
                                options: FFButtonOptions(
                            ...
                            if (FFAppState().isRiderulesAccepted == true)
                              Padding(
                                ...
                                child: InkWell(
                                  ...
                                  highlightColor: Colors.transparent,
                                  onTap: () async {
                                    FFAppState().isPredefinedItems = true;
                                    safeSetState(() {});
                                    ...
                                    context
                                        .pushNamed(Areyousure12Widget.routeName);
                                  },
                                  child: Container(
                                    width: 80.0,
                                    height: 80.0,
                            ...
                            if (FFAppState().isRiderulesAccepted == false)
                              FFButtonWidget(
                                onPressed: () async {
                                  context.pushNamed(RuleRide8BWidget.routeName);
                                },
                                text: 'Enter Manually',
                                options: FFButtonOptions(
                                  width: 120.0,
