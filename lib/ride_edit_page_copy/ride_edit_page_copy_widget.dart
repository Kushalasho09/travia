...
import 'ride_edit_page_copy_model.dart';
export 'ride_edit_page_copy_model.dart';

class RideEditPageCopyWidget extends StatefulWidget {
  const RideEditPageCopyWidget({super.key});

  static String routeName = 'RideEditPageCopy';
  static String routePath = '/rideEditPageCopy';

  @override
  State<RideEditPageCopyWidget> createState() => _RideEditPageCopyWidgetState();
}

class _RideEditPageCopyWidgetState extends State<RideEditPageCopyWidget> {
  late RideEditPageCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => RideEditPageCopyModel());
    ...
    _model.travelTimeTextController ??= TextEditingController();
    ...
    _model.driverContactnumberTextController ??= TextEditingController();
                  ...
                  children: [
                            ...
                            children: [
                                  ...
                                  child: ExpandablePanel(
                                    ...
                                    expanded: Padding(
                                      padding: EdgeInsetsDirectional.fromSTEB(
                                          0.0, 12.0, 0.0, 12.0),
                                      child: Text(
                                        'You can sign up through the driver section of our app or on our website by providing the required documents and information.',
                                        style: FlutterFlowTheme.of(context)
                                            .bodyMedium
                                            .override(
                              ...
                              Container(
                                ...
                                child: ExpandableNotifier(
                                  ...
                                  child: ExpandablePanel(
                                    header: Text(
                                      'What documents do I need to become a driver?',
                                      style: FlutterFlowTheme.of(context)
                                          .titleMedium
                                          .override(
                                            font: GoogleFonts.interTight(
                                    ...
                                    expanded: Padding(
                                      padding: EdgeInsetsDirectional.fromSTEB(
                                          0.0, 12.0, 0.0, 12.0),
                                      child: Text(
                                        'Typically, you\'ll need a valid driver\'s license, vehicle registration, proof of insurance, and possibly a background check.',
                                        style: FlutterFlowTheme.of(context)
                                            .bodyMedium
                                            .override(
                                              font: GoogleFonts.inter(
                                  ...
                                  child: ExpandablePanel(
                                    ...
                                    expanded: Padding(
                                      padding: EdgeInsetsDirectional.fromSTEB(
                                          0.0, 12.0, 0.0, 12.0),
                                      child: Text(
                                        'The approval process usually takes 3-5 business days after you submit all the required documents.',
                                        style: FlutterFlowTheme.of(context)
                                            .bodyMedium
                                            .override(
                                              font: GoogleFonts.inter(
                                    ...
                                    child: ExpandablePanel(
                                      ...
                                      expanded: Padding(
                                        padding: EdgeInsetsDirectional.fromSTEB(
                                            0.0, 12.0, 0.0, 12.0),
                                        child: Text(
                                          'Your vehicle must meet our platform\'s requirements regarding age, type, and condition. Please refer to our vehicle guidelines for more details.',
                                          style: FlutterFlowTheme.of(context)
                                              .bodyMedium
                                              .override(
                                                font: GoogleFonts.inter(
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        if (FFAppState().isPredefinedItems == false)
                          FFButtonWidget(
                            onPressed: () {
                            ...
                            children: [
                              ...
                              Container(
                                ...
                                child: TextFormField(
                                  ...
                                  obscureText: false,
                                  decoration: InputDecoration(
                                    labelText: 'Enter 10th item name',
                                    labelStyle: FlutterFlowTheme.of(context)
                                        .bodyMedium
                                        .override(
                                          font: GoogleFonts.inter(
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            child: TextFormField(
                              ...
                              obscureText: false,
                              decoration: InputDecoration(
                                labelText: 'Parcel Delivery Cost (₹ Per KM)',
                                hintStyle: FlutterFlowTheme.of(context)
                                    .bodyMedium
                                    .override(
                                      font: GoogleFonts.inter(
                          ...
                          children: [
                            Expanded(
                              child: Container(
                                width: double.infinity,
                                child: TextFormField(
                                  controller: _model.travelTimeTextController,
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: FFButtonWidget(
                              onPressed: () async {
                                if ((_model.textController26.text != null &&
                                        _model.textController26.text != '') &&
                                    (_model.textController27.text != null &&
                                        _model.textController27.text != '') &&
                                    (_model.textController28.text != null &&
                                        _model.textController28.text != '')) {
                                  ...
                                  FFAppState().rideRule4 =
                                      _model.textController29.text;
                                  FFAppState().rideRule5 =
                                      _model.textController30.text;
                                  FFAppState().rideRule6 =
                                      _model.textController31.text;
                                  FFAppState().rideRule7 =
                                      _model.textController32.text;
                                  FFAppState().rideRule8 =
                                      _model.textController33.text;
                                  safeSetState(() {});
                                  ...
                                  await showDialog(
                                    ...
                                    builder: (alertDialogContext) {
                                      return AlertDialog(
                                        ...
                                        content: Text(
                                            'Please fill minimum 4 out all required fields'),
                                        actions: [
                                          TextButton(
                      ...
                      child: InkWell(
                        ...
                        onTap: () async {
                          if ((_model.textController1.text != null &&
                            ...
                            context
                                .pushNamed(RideStartDateTime2Widget.routeName);
                          } else {
                            await showDialog(
                              context: context,
                              builder: (alertDialogContext) {
