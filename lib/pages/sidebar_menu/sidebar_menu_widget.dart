            ...
            Container(
              ...
              decoration: BoxDecoration(
                ...
                image: DecorationImage(
                  image: AssetImage('assets/images/profile_cover_bg.png'),
                  fit: BoxFit.cover,
                ),
              ),
              child: Padding(
                    ...
                    InkWell(
                      ...
                      onTap: () async {
                        ...
                        context.pushNamed(
                          HomeWidget.routeName,
                          queryParameters: {
                            'tabNumberRef': serializeParam(2, ParamType.int,),
                          }.withoutNulls,
                        );
                      },
                      child: Container(
                    ...
                    InkWell(
                      ...
                      onTap: () async {
                        context.pushNamed(
                          MarketPlaceCustomerWidget.routeName,
                          queryParameters: {
                            'tabNumberRef': serializeParam(1, ParamType.int),
                          }.withoutNulls,
                        );
                      },
                      child: Container(
                                  ...
                                  Column(
                                    ...
                                    children: [
                                      ...
                                      Container(
                                        width: 180.0,
                                        child: Text(
                                          'View your saved/bookmarked rides',
                                          style: FlutterFlowTheme.of(context).bodySmall.override(
                                                font: GoogleFonts.inter(
                                                  fontWeight: FlutterFlowTheme.of(context).bodySmall.fontWeight,
                                                  fontStyle: FlutterFlowTheme.of(context).bodySmall.fontStyle,
                                  ...
                                  children: [
                                    ...
                                    Column(
                                      ...
                                      children: [
                                        ...
                                        Container(width: 180,
                                          child: Text(
                                            'Refer & Earn Ride points and utilise them in redeeming free subscription',
                                            style: FlutterFlowTheme.of(context).bodySmall.override(
                                                  font: GoogleFonts.inter(
                                                    fontWeight: FlutterFlowTheme.of(context).bodySmall.fontWeight,
                                                    fontStyle: FlutterFlowTheme.of(context).bodySmall.fontStyle,
