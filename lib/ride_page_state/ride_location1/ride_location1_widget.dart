...
class _RideLocation1WidgetState extends State<RideLocation1Widget> {
  ...
  void initState() {
    ...
    _model.rideStartLocationFocusNode!.addListener(_handleFocusChange);
    _model.rideEndLocationFocusNode!.addListener(_handleFocusChange);
  ...
  void _handleFocusChange() {
    setState(() {
      _showImage = !(_model.rideStartLocationFocusNode!.hasFocus ||
          _model.rideEndLocationFocusNode!.hasFocus);
    });
  }
                                  ...
                                  child: GooglePlaceAutoCompleteTextField(
                                    ...
                                    getPlaceDetailWithLatLng: (prediction) {
                                      if (prediction.lat != null && prediction.lng != null) {
                                        ...
                                        FFAppState().GoogleStartAddress = prediction.description ?? "";
                                        safeSetState(() {});
                                      }
                                    },
                                  ...
                                  child: GooglePlaceAutoCompleteTextField(
                                    ...
                                    getPlaceDetailWithLatLng: (prediction) {
                                      if (prediction.lat != null && prediction.lng != null) {
                                        ...
                                        FFAppState().GoogleEndAddress = prediction.description ?? "";
                                        safeSetState(() {});
                                      }
                                    },
                                    itemClick: (prediction) {
