...
import 'listof_items4_model.dart';
export 'listof_items4_model.dart';

class ListofItems4Widget extends StatefulWidget {
  const ListofItems4Widget({super.key});

  static String routeName = 'ListofItems4';
  static String routePath = '/listofItems4';

  @override
  State<ListofItems4Widget> createState() => _ListofItems4WidgetState();
}

class _ListofItems4WidgetState extends State<ListofItems4Widget> {
  late ListofItems4Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ListofItems4Model());
  }
