...
import 'rule_ride8_model.dart';
export 'rule_ride8_model.dart';

class RuleRide8Widget extends StatefulWidget {
  const RuleRide8Widget({super.key});

  static String routeName = 'ruleRide8';
  static String routePath = '/ruleRide8';

  @override
  State<RuleRide8Widget> createState() => _RuleRide8WidgetState();
}

class _RuleRide8WidgetState extends State<RuleRide8Widget> {
  late RuleRide8Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => RuleRide8Model());
  }
                            ...
                            Padding(
                              ...
                              child: InkWell(
                                ...
                                onTap: () async {
                                  ...
                                  context
                                      .pushNamed(ParcelCost6Widget.routeName);
                                },
                                child: Container(
                                  width: 80.0,
                                  height: 80.0,
