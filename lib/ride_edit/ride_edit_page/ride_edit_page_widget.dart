                                          ...
                                          children: [
                                            ...
                                            Container(
                                              ...
                                              child: GooglePlaceAutoCompleteTextField(
                                                ...
                                                textEditingController: _model.rideStartLocationTextController ??= TextEditingController(
                                                ...
                                                itemClick: (prediction) {
                                                  ...
                                                  _model.rideStartLocationTextController!.text = desc;
                                            ...
                                            Container(
                                              ...
                                              child: GooglePlaceAutoCompleteTextField(
                                                ...
                                                textEditingController: _model.rideEndLocatioTextController ??= TextEditingController(
                                                ...
                                                itemClick: (prediction) {
                                                  final desc = prediction.description ?? "";
                                                  _model.rideEndLocatioTextController!.text = desc;
                                                  _model.rideEndLocatioTextController!.selection = TextSelection.fromPosition(
                                                    TextPosition(offset: desc.length),
                                                  );
                                                },
                                                itemBuilder: (context, index, prediction) {
                                            ...
                                            FFButtonWidget(
                                              onPressed: () async {
                                                try {
                                                  await rideEditPageRidesNewRecord.reference.update(
                                                    createRidesNewRecordData(
                                                      rideStartLocation: _model.rideStartLocationTextController?.text ?? '',
                                                      rideEndLocation: _model.rideEndLocatioTextController?.text ?? '',
                                                    ),
                                                  );

                                                  if (!mounted) return;
                                                  _model.expandableExpandableController1?.expanded = false;
                                                ...
                                                final _datePicked1Date = await showDatePicker(
                                                  ...
                                                  builder: (context, child) {
                                                    return wrapInMaterialDatePickerTheme(
                                                      context,
                                                      child!,
                                                      headerBackgroundColor: const Color(0xFFF9814F),
                                                      ...
                                                      selectedDateTimeBackgroundColor: const Color(0xFFF9814F),
                                            ...
                                            FFButtonWidget(
                                              onPressed: () async {
                                                try {
                                                  ...
                                                  if (!mounted) return;
                                                  _model.expandableExpandableController2.expanded = false; // Closes panel
                                          ...
                                          children: [
                                            ...
                                            FFButtonWidget(
                                              onPressed: () async {
                                                try {
                                                  await widget!.rideEdit!.update(createRidesNewRecordData(
                                                    isPredefinedItems: rideEditPageRidesNewRecord.isPredefinedItems,
                                                  ));

                                                  if (!mounted) return;
                                                  _model.expandableExpandableController3?.expanded = false;
                                                  ScaffoldMessenger.of(context).showSnackBar(
                                                    const SnackBar(
                                                      content: Text('Carry items updated successfully'),
                                                      backgroundColor: Colors.green,
                                                    ),
                                                  );
                                                } catch (e) {
                                                  ...
                                                  ScaffoldMessenger.of(context).showSnackBar(
                                                    SnackBar(
                                                      content: Text('Failed to update carry items: $e'),
                                                      backgroundColor: Colors.red,
                                                    ),
                                                  );
                                                }
                                        ...
                                        expanded: Column(
                                          ...
                                          children: [
                                                ...
                                                children: [
                                                  ...
                                                  Container(
                                                    ...
                                                    child: TextFormField(
                                                      ...
                                                      cursorColor: const Color(0xFF1A5FB4),
                                            ...
                                            FFButtonWidget(
                                              onPressed: () async {
                                                try {
                                                  if (_model.fullCostTextController!.text.trim().isNotEmpty) {
                                                    await widget!.rideEdit!.update(createRidesNewRecordData(
                                                      totalDeliveryCost: _model.fullCostTextController!.text.trim(),
                                                    ));

                                                    if (!mounted) return;
                                                    _model.expandableExpandableController4?.expanded = false;
                                                    ScaffoldMessenger.of(context).showSnackBar(
                                                      const SnackBar(
                                                        content: Text('Cost updated successfully'),
                                                        backgroundColor: Colors.green,
                                                      ),
                                                    );
                                                  } else {
                                                  ...
                                                  ScaffoldMessenger.of(context).showSnackBar(
                                                    SnackBar(
                                                      content: Text('Failed to update cost: $e'),
                                                      backgroundColor: Colors.red,
                                                    ),
                                                  );
                                                }
                                        ...
                                        expanded: Column(
                                          ...
                                          children: [
                                            ...
                                            FFButtonWidget(
                                              onPressed: () async {
                                                try {
                                                  if (_model.travelTimeTextController!.text.trim().isNotEmpty) {
                                                    await widget!.rideEdit!.update(createRidesNewRecordData(
                                                      travelTime: _model.travelTimeTextController!.text.trim(),
                                                    ));

                                                    if (!mounted) return;
                                                    _model.expandableExpandableController5?.expanded = false;
                                                    ScaffoldMessenger.of(context).showSnackBar(
                                                      const SnackBar(
                                                        content: Text('Travel time updated successfully'),
                                                        backgroundColor: Colors.green,
                                                      ),
                                                    );
                                                  } else {
                                                    await showDialog(
                                                      ...
                                                      builder: (alertDialogContext) {
                                                        return AlertDialog(
                                                          title: const Text('Attention'),
                                                          content: const Text('Please fill travel time'),
                                                          actions: [
                                                            TextButton(
                                                              onPressed: () => Navigator.pop(alertDialogContext),
                                                              child: const Text('Ok'),
                                                  ...
                                                  ScaffoldMessenger.of(context).showSnackBar(
                                                    SnackBar(
                                                      content: Text('Failed to update travel time: $e'),
                                                      backgroundColor: Colors.red,
                                                    ),
                                                  );
                                                }
                                        ...
                                        expanded: Column(
                                          ...
                                          children: [
                                            ...
                                            FFButtonWidget(
                                              onPressed: () async {
                                                try {
                                                  // Check if at least 3 rules are filled
                                                  if (_model.rideRule1TextController!.text.trim().isNotEmpty &&
                                                      _model.rideRule2TextController!.text.trim().isNotEmpty &&
                                                      _model.rideRule3TextController!.text.trim().isNotEmpty) {

                                                    await widget!.rideEdit!.update(createRidesNewRecordData(
                                                      rideRule1: _model.rideRule1TextController!.text.trim(),
                                                      rideRule2: _model.rideRule2TextController!.text.trim(),
                                                      rideRule3: _model.rideRule3TextController!.text.trim(),
                                                      // rideRule4: _model.rideRule4TextController?.text.trim().isNotEmpty ? _model.rideRule4TextController!.text.trim() : null,
                                                      // rideRule5: _model.rideRule5TextController?.text.trim().isNotEmpty ? _model.rideRule5TextController!.text.trim() : null,
                                                      // rideRule6: _model.rideRule6TextController?.text.trim().isNotEmpty ? _model.rideRule6TextController!.text.trim() : null,
                                                    ));

                                                    if (!mounted) return;
                                                    _model.expandableExpandableController6?.expanded = false;
                                                    ScaffoldMessenger.of(context).showSnackBar(
                                                      const SnackBar(
                                                        content: Text('Ride rules updated successfully'),
                                                        backgroundColor: Colors.green,
                                                      ),
                                                    );
                                                  } else {
                                                    await showDialog(
                                                      ...
                                                      builder: (alertDialogContext) {
                                                        return AlertDialog(
                                                          title: const Text('Attention'),
                                                          content: const Text('Please add at least 3 ride rules'),
                                                          actions: [
                                                            TextButton(
                                                              onPressed: () => Navigator.pop(alertDialogContext),
                                                              child: const Text('Ok'),
                                                  ...
                                                  ScaffoldMessenger.of(context).showSnackBar(
                                                    SnackBar(
                                                      content: Text('Failed to update ride rules: $e'),
                                                      backgroundColor: Colors.red,
                                                    ),
                                                  );
                                                }
                                        ...
                                        expanded: Column(
                                          ...
                                          children: [
                                            ...
                                            FFButtonWidget(
                                              onPressed: () async {
                                                try {
                                                  if (_model.driverContactnumberTextController!.text.trim().isNotEmpty) {
                                                    await widget!.rideEdit!.update(createRidesNewRecordData(
                                                      driverNumber: _model.driverContactnumberTextController!.text.trim(),
                                                      vehicleNumber: _model.vehicleNumberTextController!.text.trim().isNotEmpty
                                                          ? _model.vehicleNumberTextController!.text.trim()
                                                          : null,
                                                    ));

                                                    if (!mounted) return;
                                                    _model.expandableExpandableController7?.expanded = false; // Replace X with correct controller number
                                                    ScaffoldMessenger.of(context).showSnackBar(
                                                      const SnackBar(
                                                    ...
                                                    await showDialog(
                                                      ...
                                                      builder: (alertDialogContext) {
                                                        return AlertDialog(
                                                          title: const Text('Attention'),
                                                          content: const Text('Please add Driver Number'),
                                                          actions: [
                                                            TextButton(
                                                              onPressed: () => Navigator.pop(alertDialogContext),
                                                              child: const Text('Ok'),
                                                  ...
                                                  ScaffoldMessenger.of(context).showSnackBar(
                                                    SnackBar(
                                                      content: Text('Failed to update driver details: $e'),
                                                      backgroundColor: Colors.red,
                                                    ),
                                                  );
                                                }
