...
abstract class FlutterFlowTheme {
  ...
  late Color boxColour;
  late Color otherColour;
  late Color containerColour;
  late Color iconColours;
...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF2B3C58);
  ...
  late Color containerBG = const Color(0xFFE0E3E7);
  late Color boxColour = const Color(0xFFF5F5F5);
  late Color otherColour = const Color(0xFFF57C3B);
  late Color containerColour = const Color(0xFFF4F4F4);
  late Color iconColours = const Color(0xFF929090);
}
