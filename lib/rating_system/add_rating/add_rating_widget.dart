...
/// create a page to post review for a driver in cab booking app.
///
/// Add all option and details bases on your own research.
                          ...
                          child: Padding(
                            ...
                            child: Row(
                              ...
                              children: [
                                Builder(
                                  builder: (context) {
                                    if (addRatingUsersRecord.photoUrl != null &&
                                ...
                                Expanded(
                                  child: Column(
                                    ...
                                    children: [
                                      Text(
                                        addRatingUsersRecord.displayName,
                          ...
                          children: [
                            ...
                            TextFormField(
                              ...
                              decoration: InputDecoration(
                                hintText:
                                    'Tell us more about your ride experience...',
                              ...
                              validator: _model
                                  .reviewWordsTextControllerValidator
                                  .asValidator(context),
                              inputFormatters: [
                                if (!isAndroid && !isiOS)
                        ...
                        onPressed: () async {
                          if (_model.ratingBarValue != null) {
                            await ReviewRecord.createDoc(widget!.userRef!)
                              ...
                              review: _model.reviewWordsTextController.text,
                            ...
                            ScaffoldMessenger.of(context).showSnackBar(
                              SnackBar(
                                content: Text(
                                  'You have successfully added a review. This will help other users to book the right ride.',
                                  style: TextStyle(
                                    color: FlutterFlowTheme.of(context)
                                        .primaryText,
                                  ),
                            ...
                            await showDialog(
                              ...
                              builder: (alertDialogContext) {
                                return AlertDialog(
                                  ...
                                  content: Text('Please select ratings to go ahead.'),
                                  actions: [
                                    TextButton(
                                      onPressed: () =>
